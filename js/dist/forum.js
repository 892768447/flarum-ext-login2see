...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add("irony/login-to-see", function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, "config", function () {
    if (!flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.session.user && flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.current instanceof flarum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_3___default.a) $(".login2see_login").off("click").on("click", function () {
      return flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.modal.show(new flarum_components_LogInModal__WEBPACK_IMPORTED_MODULE_4___default.a());
    });
  });
});
